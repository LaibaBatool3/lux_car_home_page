...
const BuyNowCard = ({ image, title, creator, currentBid, buyPrice }) => {
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition p-3 md:p-4">
      ...
      <div className="pt-4">
        <div className="flex items-center justify-between mb-1">
          <h3 className="text-gray-900 font-semibold text-sm md:text-base truncate" title={title}>{title}</h3>
          <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#E94141] text-white">BID</span>
        </div>
