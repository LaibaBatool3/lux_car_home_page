    ...
    <section className="bg-[#F8F8F8] py-16">
      <div className="w-[1041px] max-w-full mx-auto px-4">
        ...
        <div className="flex justify-center mt-10">
          <button className="px-8 md:px-10 py-3.5 rounded-full bg-[#F3F3F6] shadow hover:shadow-md transition text-[#E94141] font-semibold border border-[#CA0000]" style={{ boxShadow: '0 8px 24px rgba(0,0,0,0.12)' }}>
            Load More
          </button>
        </div>
      </div>
